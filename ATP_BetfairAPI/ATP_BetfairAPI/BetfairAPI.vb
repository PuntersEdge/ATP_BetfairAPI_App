...
#End Region
    ...
    Public Function GetSessionKey(AppKey As String, postData As String)
        ...
        Dim con As New SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("PuntersEdgeSessionKey").ConnectionString)
    ...
    Public Function CreateRequest(AppKey As String, SessToken As String)
        ...
        Dim postData As String = "{""jsonrpc"": ""2.0"",""method"":""SportsAPING/v1.0/listMarketCatalogue"",""params"":{""filter"":{""eventTypeIds"":[""7""],""marketCountries"":[""GB"",""IE""] ,""marketTypeCodes"":[""WIN"",""PLACE""],""marketStartTime"":{" & daterange & "}},""venues"":[],""sort"":""FIRST_TO_START"",""maxResults"":250,""marketProjection"":[""MARKET_START_TIME"", ""EVENT""],""marketStatus"":""OPEN"" },""id"": 1}"
    ...
    End Function '~~>Gets market ID's of races
